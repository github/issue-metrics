...
| `HIDE_ITEMS_LIST`             | False    | False                                      | If set to `true`, the individual items list table will not be displayed in the generated Markdown file. Only the summary metrics will be shown.                                                                                                                                                            |
